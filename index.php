		...
		<main class="main">
			<div class="sect">
				<div class="sect-header">
					<div class="sect-title"> Фильмы</div>
				</div>
				...
				<?php
					if($serials){
						foreach($serials as $serial){
						     echo '<div class="image-container"><a href="/details.php?serial_id='.$serial['id'].'"><img class="poster" src="'. $serial['poster_serial']. '" alt="Постер сериала"></a>
